...
contract V00_Marketplace is Ownable {
    ...
    */
    ...
    function createListing(bytes32 _ipfsHash, uint _deposit, address _depositManager, uint _refund)
        public
    {
        _createListing(msg.sender, _ipfsHash, _deposit, _depositManager, _refund);
    }
        ...
        public returns (bool)
    {
        ...
        _createListing(_seller, _ipfsHash, _deposit, _depositManager, _refund);
        return true;
    }
    ...
    function finalize(uint listingID, uint offerID, bytes32 _ipfsHash) public {
        ...
        delete offers[listingID][offerID];
        //test update listing.seller = listing.buyer
        listings.push(Listing({
            seller: offer.buyer,
            deposit: listing.deposit,
            depositManager: listing.depositManager,
            refund: listing.refund
